...
SECRET_KEY = 'django-insecure-_2%g_cey&b4w4hzdm(%st&76z_wtasx0af69qips$ju27d=+ij'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'timetable_db1',  # database name
...
LOGGING = {
    ...
    'handlers': {
        'console': {
            ...
            'level': 'INFO',  # Only show INFO and above in production
        },
    },
    'loggers': {
        '': {
